...
function template_main()
{
	...
	<div id="statistics" class="main_section">
		...
		<div class="lff-l4-heading">
			<img src="', $settings['images_url'], '/stats_info.gif" class="icon" alt="" />
			<h4>', $txt['general_stats'], '</h4>
		</div>
	...
	echo '
		...
		<div class="flow_hidden">
			<div id="top_posters">
				<div class="lff-l4-heading">
					<img src="', $settings['images_url'], '/stats_posters.gif" class="icon" alt="" />
					<h4>', $txt['top_posters'], '</h4>
				</div>
					<div class="windowbg2 rounded-content">
						<div class="content">
							<dl class="stats">';
	...
	echo '
			...
			<div id="top_boards">
				<div class="lff-l4-heading">
					<img src="', $settings['images_url'], '/stats_board.gif" class="icon" alt="" />
	...
	echo '
		...
		<div class="flow_hidden">
			<div id="top_topics_replies">
				<div class="lff-l4-heading">
					<img src="', $settings['images_url'], '/stats_replies.gif" class="icon" alt="" />
	...
	echo '
			...
			<div id="top_topics_views">
				<div class="lff-l4-heading">
					<img src="', $settings['images_url'], '/stats_views.gif" class="icon" alt="" />
	...
	if (!empty($context['yearly']))
	{
		...
		<table border="0" width="100%" cellspacing="1" cellpadding="4" class="table_grid" id="stats">
			<thead>
				<tr class="lff-list-header" valign="middle" align="center">
					<th class="first_th lefttext" width="25%"><div class="lff-list-header-content">', $txt['yearly_summary'], '</div></th>
					<th width="15%"><div class="lff-list-header-content">', $txt['stats_new_topics'], '</div></th>
					<th width="15%"><div class="lff-list-header-content">', $txt['stats_new_posts'], '</div></th>
					<th width="15%"><div class="lff-list-header-content">', $txt['stats_new_members'], '</div></th>
					<th', empty($modSettings['hitStats']) ? ' class="last_th"' : '', ' width="15%"><div class="lff-list-header-content">', $txt['smf_stats_14'], '</div></th>';

		if (!empty($modSettings['hitStats']))
			echo '
					<th class="last_th"><div class="lff-list-header-content">', $txt['page_views'], '</div></th>';
