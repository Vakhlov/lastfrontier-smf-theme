		...
		<fieldset class="flow_hidden">
			<div class="roundframe content rounded-content">
				<div class="lff-l4-heading">
					<a href="javascript:void(0);" onclick="expandCollapseBoards(); return false;"><img src="', $settings['images_url'], '/expand.gif" id="expandBoardsIcon" alt="" /></a>
					<h4 onclick="expandCollapseBoards(); return false;">', $txt['choose_board'], '</h4>
				</div>
