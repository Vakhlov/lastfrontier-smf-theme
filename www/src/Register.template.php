...
function template_registration_agreement()
{
	...
	if (!empty($context['agreement']))
		echo '
			...
			<div class="roundframe content rounded-content">
...
function template_admin_register()
{
	...
	<div id="admincenter">
		...
		<form class="windowbg2 rounded-content" action="', $scripturl, '?action=admin;area=regcenter" method="post" accept-charset="', $context['character_set'], '" name="postForm" id="postForm">
			<script type="text/javascript"><!-- // --><![CDATA[
...
function template_edit_agreement()
{
	...
	echo '
		<div class="windowbg2 rounded-content" id="registration_agreement">
			<div class="content">';
...
function template_edit_reserved_words()
{
	...
	echo '
		...
		<form id="registration_agreement" class="windowbg2 rounded-content" action="', $scripturl, '?action=admin;area=regcenter" method="post" accept-charset="', $context['character_set'], '">
			<div class="content">
...
function template_edit_privacy_policy()
{
	...
	echo '
		<div class="windowbg2 rounded-content" id="privacy_policy">
			<div class="content">';
