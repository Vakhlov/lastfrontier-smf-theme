	...
	<div id="admincenter">
		<form action="', $scripturl, '?action=admin;area=news;sa=editnews" method="post" accept-charset="', $context['character_set'], '" name="postmodify" id="postmodify">
			<table class="table_grid" width="100%">
				<thead>
					<tr class="lff-news-list-header">
						<th width="50%"><div class="lff-news-list-header-content">', $txt['admin_edit_news'], '</div></th>
						<th align="left" width="45%"><div class="lff-news-list-header-content">', $txt['preview'], '</div></th>
						<th align="center" width="5%"><div class="lff-news-list-header-content"><input type="checkbox" class="input_check" onclick="invertAll(this, this.form);" /></div></th>
					</tr>
				</thead>
				<tbody>';
